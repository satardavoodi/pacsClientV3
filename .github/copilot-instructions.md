...
**Current Stable Version:** v3.3.1 (2026-06-16) - Minor release: latest stable consolidation build with current local changes. See `docs/releases/VERSION_3.3.1_RELEASE.md`.
