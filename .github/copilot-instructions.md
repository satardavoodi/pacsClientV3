...
**Current Stable Version:** v3.4.0 (2026-06-28) - Minor release: latest stable consolidation build with current local changes. See `docs/releases/VERSION_3.4.0_RELEASE.md`.

**Previous Stable:** v3.3.9 (2026-06-27) - Minor release: latest stable consolidation build with current local changes. See `docs/releases/VERSION_3.3.9_RELEASE.md`.
