...
**Current Stable Version:** v3.2.9 (2026-06-14) - Minor release: latest stable consolidation build with current local changes. See `docs/releases/VERSION_3.2.9_RELEASE.md`.
