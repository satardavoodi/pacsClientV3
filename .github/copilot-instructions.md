...
**Current Stable Version:** v3.1.3 (2026-05-27) — Patch: installer v3.1.3. See `docs/releases/VERSION_3.1.3_RELEASE.md`.

**Previous Stable:** v3.1.2 (2026-05-26) — Patch: responsive UI scaling + installer v3.1.2. See `docs/releases/VERSION_3.1.2_RELEASE.md`.

**Previous Stable:** v3.1.1 (2026-05-26) — Patch: production installers + stability. See `docs/releases/VERSION_3.1.1_RELEASE.md`.
