...
**Current Stable Version:** v3.4.3 (2026-07-02) - Patch release: latest stable consolidation build with current local changes. See `docs/releases/VERSION_3.4.3_RELEASE.md`.

**Previous Stable:** v3.4.2 (2026-07-01) - Patch release: latest stable consolidation build with current local changes. See `docs/releases/VERSION_3.4.2_RELEASE.md`.
