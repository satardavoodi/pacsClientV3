...
**Current Stable Version:** v3.2.8 (2026-06-13) - Minor release: latest stable consolidation build with current local changes. See `docs/releases/VERSION_3.2.8_RELEASE.md`.
