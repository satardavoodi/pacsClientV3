...
**Current Stable Version:** v3.4.5 (2026-07-04) - Patch release: latest stable consolidation build with current local changes. See `docs/releases/VERSION_3.4.5_RELEASE.md`.

**Previous Stable:** v3.4.4 (2026-07-03) - Patch release: latest stable consolidation build with current local changes. See `docs/releases/VERSION_3.4.4_RELEASE.md`.
