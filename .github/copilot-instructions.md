...
**Current Stable Version:** v3.3.0 (2026-06-15) - Minor release: latest stable consolidation build with current local changes. See `docs/releases/VERSION_3.3.0_RELEASE.md`.
