...
**Current Stable Version:** v3.0.3 (2026-05-16) — FAST-to-MPR route hardening and geometry boundary stabilization build, including MPR launch routing, VTK bridge fixes, and release snapshot packaging. See `docs/releases/VERSION_3.0.3_RELEASE.md`.
