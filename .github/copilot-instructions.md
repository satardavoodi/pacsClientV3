...
**Current Stable Version:** v3.4.8 (2026-07-11) - Patch release: latest stable consolidation build with current local changes. See `docs/releases/VERSION_3.4.8_RELEASE.md`.

**Previous Stable:** v3.4.7 (2026-07-08) - Patch release: latest stable consolidation build with current local changes. See `docs/releases/VERSION_3.4.7_RELEASE.md`.
