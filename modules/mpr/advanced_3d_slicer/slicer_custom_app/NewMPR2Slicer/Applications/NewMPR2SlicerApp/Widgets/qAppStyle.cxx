...
//------------------------------------------------------------------------------
// AI-PACS Advanced Viewer: DARK THEME PALETTE
// ===========================================================================
// This palette is designed to match NewMPR2Slicer.qss dark theme colors.
// By setting a dark palette in C++, we eliminate the "light to dark flash"
// that previously occurred when Python applied the QSS after window show.
//
// Color Palette Reference (from NewMPR2Slicer.qss):
//   Background 1:       #21272a (main background)
//   Background 2:       #1a1e21 (secondary)
//   Background 3:       #14181a (darker panels)
//   Background 4:       #0f1214 (borders, separators)
...
QPalette qAppStyle::standardPalette()const
{
  ...
  // Main window and widget backgrounds - DARK (#21272a)
  palette.setColor(QPalette::Active, QPalette::Window, "#21272a");
  palette.setColor(QPalette::Inactive, QPalette::Window, "#21272a");
  palette.setColor(QPalette::Disabled, QPalette::Window, "#1a1e21");

  // Text colors - LIGHT (#fefefe primary, #989898 disabled)
  palette.setColor(QPalette::Active, QPalette::WindowText, "#fefefe");
  palette.setColor(QPalette::Inactive, QPalette::WindowText, "#CBCBCB");
  palette.setColor(QPalette::Disabled, QPalette::WindowText, "#656565");
  palette.setColor(QPalette::Active, QPalette::Text, "#fefefe");
  palette.setColor(QPalette::Inactive, QPalette::Text, "#CBCBCB");
  palette.setColor(QPalette::Disabled, QPalette::Text, "#656565");

  // Base colors (text input backgrounds) - slightly darker
  palette.setColor(QPalette::Active, QPalette::Base, "#14181a");
  palette.setColor(QPalette::Inactive, QPalette::Base, "#14181a");
  palette.setColor(QPalette::Disabled, QPalette::Base, "#1a1e21");

  // Light/Dark for 3D effects
  palette.setColor(QPalette::Light, "#3b82f6");  // Blue accent for highlights
  palette.setColor(QPalette::Dark, "#0f1214");   // Darkest for shadows

  // Button colors - dark button background
  palette.setColor(QPalette::Button, "#14181a");
  palette.setColor(QPalette::Mid, "#1a1e21");
  palette.setColor(QPalette::Active, QPalette::ButtonText, "#fefefe");
  palette.setColor(QPalette::Inactive, QPalette::ButtonText, "#CBCBCB");
  palette.setColor(QPalette::Disabled, QPalette::ButtonText, "#656565");
  palette.setColor(QPalette::Shadow, "#0b0d0e");

  // Highlight colors - Blue accent (#60a5fa primary, #2563eb active)
  palette.setColor(QPalette::Highlight, "#2563eb");
  palette.setColor(QPalette::HighlightedText, "#fefefe");

  // AlternateBase for list/table alternating rows
  palette.setColor(QPalette::AlternateBase, "#1a1e21");

  // ToolTip colors
  palette.setColor(QPalette::ToolTipBase, "#14181a");
  palette.setColor(QPalette::ToolTipText, "#fefefe");

  // Link colors
  palette.setColor(QPalette::Link, "#60a5fa");
  palette.setColor(QPalette::LinkVisited, "#3b82f6");
