...
ACTION_SIDE_EFFECTS: dict[str, str] = {
    ...
    "get_viewport_context": READ_ONLY,
    "get_measurements": READ_ONLY,
    # ── download reads ──
    ...
    "capture_viewport": LOCAL_WRITE,
    "activate_tool": LOCAL_WRITE,
    "measure_distance": LOCAL_WRITE,
    ...
    "browser_get_title": READ_ONLY,
    "browser_get_text": READ_ONLY,
    "browser_get_html": READ_ONLY,
    "browser_dom_summary": READ_ONLY,
    "browser_dom_snapshot": READ_ONLY,
    "browser_accessibility_tree": READ_ONLY,
    "browser_selected_text": READ_ONLY,
    "browser_selected_element": READ_ONLY,
    "browser_get_links": READ_ONLY,
    "browser_get_buttons": READ_ONLY,
    "browser_get_inputs": READ_ONLY,
    "browser_extract_table": READ_ONLY,
    "browser_find_element": READ_ONLY,
    "browser_scroll_state": READ_ONLY,
    "browser_network": READ_ONLY,
    "browser_clear_network": READ_ONLY,
    "browser_structured_data": READ_ONLY,
    "browser_screenshot": READ_ONLY,
    "browser_go_back": UI_NAV,
    "browser_go_forward": UI_NAV,
    "browser_reload": UI_NAV,
    "browser_scroll": UI_NAV,
    "browser_fill_field": LOCAL_WRITE,
    "browser_type_text": LOCAL_WRITE,
