# AIPacs v3.1.9 Release Notes

**Release date:** 2026-06-02
**Branch:** beta-version
**Previous stable:** v3.1.8

---

## Summary

v3.1.9 is a minor release consolidating the v3.1.8 codebase with production stability
improvements and final v3.1.9 production installer (698 MB, Inno Setup 6). All v3.1.8
...
The following canonical version markers are set to `3.1.9`:

- `pyproject.toml` -> `version = "3.1.9"`
- `main.py` -> `app.setApplicationVersion("3.1.9")`
- `docs/README.md` -> current stable `v3.1.9`
- `docs/releases/RELEASE_NOTES.md` -> current stable `v3.1.9`
- `.github/copilot-instructions.md` -> current stable `v3.1.9`
...
### All v3.1.8 Features (carried forward)
...
- All v3.1.8 codebase + version bump to 3.1.9 committed
- Tag `v3.1.9` created for release traceability
