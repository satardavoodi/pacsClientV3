...
## v3.3.5 (2026-06-21) - Minor release: fresh stable build under 3.3.5

### Summary

Minor release to advance the stable version line to 3.3.5 and generate a
fresh release build from the current beta-version state.

### Included

- Canonical version markers advanced to v3.3.5
- Release documentation updated for the v3.3.5 stable line
...
## v3.3.3 (2026-06-17) - Minor release: full local-state publication and multi-remote sync

### Summary

Minor release consolidating the latest beta-version source state and publishing
the complete local working tree under the 3.3.3 release line.

### Included

- Canonical version markers advanced to v3.3.3
- Release documentation updated for the v3.3.3 stable line
...
## v3.3.0 (2026-06-15) - Minor release: full local-state publication and multi-remote sync

### Summary

Minor release consolidating the latest beta-version source state and publishing
the complete local working tree under the 3.3.0 release line.

### Included

- Canonical version markers advanced to v3.3.0
- Release documentation updated for the v3.3.0 stable line
- Full local repository state committed for release publication
- Remote sync prepared for all requested GitHub remotes/branches

---

## v3.2.9 (2026-06-14) - Minor release: major local-state publication and multi-remote sync

### Summary

Minor release consolidating the latest beta-version source state and publishing
the complete local working tree under the 3.2.9 release line.

### Included

- Canonical version markers advanced to v3.2.9
- Release documentation updated for the v3.2.9 stable line
- Full local repository state committed for release publication
- Remote sync prepared for all requested GitHub remotes

---

## v3.2.8 (2026-06-13) - Minor release: major local-state publication and multi-remote sync

### Summary

Minor release consolidating the latest beta-version source state and publishing
the complete local working tree under the 3.2.8 release line.

### Included

- Canonical version markers advanced to v3.2.8
- Release documentation updated for the v3.2.8 stable line
- Full local repository state committed for release publication
- Remote sync prepared for all requested GitHub remotes
...
## v3.2.7 (2026-06-11) - Minor release: full local-state publication and multi-remote sync

### Summary

Minor release consolidating the latest beta-version source state and publishing
the complete local working tree under the 3.2.7 release line.

### Included

- Canonical version markers advanced to v3.2.7
- Release documentation updated for the v3.2.7 stable line
- Full local repository state committed for release publication
- Remote sync prepared for all requested GitHub remotes
...
## v3.2.2 (2026-06-06) - Minor release: v3.2.2 production updates

### Summary

Minor release consolidating the v3.2.1 codebase with production stability improvements
and final v3.2.2 production installer (698 MB, Inno Setup 6). All v3.2.1 and prior
production improvements and test infrastructure, command bus, and KPI system features
are carried forward and included in the bundled executable.

### Included

- Final v3.2.2 production installer (698 MB, Inno Setup 6)
- All v3.2.1 features (production stability improvements)
- All v3.2.0 features (comprehensive production enhancements)
- All v3.1.9 features (production stability improvements)
- All v3.1.8 features (production stability improvements)
- All v3.1.7 features (production stability improvements)
...
## v3.2.1 (2026-06-05) - Minor release: v3.2.1 production updates

### Summary

Minor release consolidating the v3.2.0 codebase with production stability improvements
and final v3.2.1 production installer (698 MB, Inno Setup 6). All v3.2.0 and prior
production improvements and test infrastructure, command bus, and KPI system features
are carried forward and included in the bundled executable.

### Included

- Final v3.2.1 production installer (698 MB, Inno Setup 6)
- All v3.2.0 features (comprehensive production enhancements)
- All v3.1.9 features (production stability improvements)
- All v3.1.8 features (production stability improvements)
- All v3.1.7 features (production stability improvements)
...
## v3.2.0 (2026-06-02) - Major release: v3.2.0 production milestone

### Summary

Major release consolidating the v3.1.9 codebase with comprehensive production enhancements
and final v3.2.0 production installer (698 MB, Inno Setup 6). All v3.1.9 production
improvements and prior test infrastructure, command bus, and KPI system features are
carried forward and included in the bundled executable.

### Included

- Final v3.2.0 production installer (698 MB, Inno Setup 6)
- All v3.1.9 features (production stability improvements)
- All v3.1.8 features (production stability improvements)
- All v3.1.7 features (production stability improvements)
- All v3.1.6 features (production stability improvements)
...
## v3.1.9 (2026-06-02) - Minor release: v3.1.9 production updates

### Summary

Minor release consolidating the v3.1.8 codebase with production stability improvements
and final v3.1.9 production installer (698 MB, Inno Setup 6). All v3.1.8 and v3.0.9
features carried forward.

### Included

- Final v3.1.9 production installer (698 MB, Inno Setup 6)
- All v3.1.8 features (production stability improvements)
- All v3.1.7 features (production stability improvements)
- All v3.1.6 features (production stability improvements)
- All v3.1.5 features (test infrastructure, command bus, KPI system)
...
## v3.1.8 (2026-06-02) - Minor release: v3.1.8 production updates

### Summary

Minor release consolidating the v3.1.7 codebase with production stability improvements
and final v3.1.8 production installer (698 MB, Inno Setup 6). All v3.1.7 and v3.0.9
features carried forward.

### Included

- Final v3.1.8 production installer (698 MB, Inno Setup 6)
- All v3.1.7 features (production stability improvements)
- All v3.1.6 features (production stability improvements)
- All v3.1.5 features (test infrastructure, command bus, KPI system)
- All v3.0.9+ codebase (responsive UI, crash hardening, EULA, multi-study viewer)
...
## v3.1.6 (2026-06-01) - Minor release: v3.1.6 production updates

### Summary

Minor release consolidating the v3.1.5 codebase with production stability improvements
and final v3.1.6 production installer (698 MB, Inno Setup 6). All v3.1.5 and v3.0.9
features carried forward.

### Included

- Final v3.1.6 production installer (698 MB, Inno Setup 6)
- All v3.1.5 features (test infrastructure, command bus, KPI system)
- All v3.0.9+ codebase (responsive UI, crash hardening, EULA, multi-study viewer)
- Production stability enhancements
...
## v3.1.5 (2026-05-28) - Final release: v3.1.5 installer

### Summary

Final release consolidating the v3.1.4 codebase with final v3.1.5 production
installer (687 MB, Inno Setup). All v3.1.4 and v3.0.9 features carried forward.

### Included

- Final v3.1.5 production installer (687 MB)
- All v3.1.4 features (test infrastructure, command bus, KPI system)
- All v3.0.9+ codebase (responsive UI, crash hardening, EULA, multi-study viewer)
