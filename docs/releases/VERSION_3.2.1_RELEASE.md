# AIPacs v3.2.1 Release Notes

**Release date:** 2026-06-05
**Branch:** beta-version
**Previous stable:** v3.2.0

---

## Summary

v3.2.1 is a minor release consolidating the v3.2.0 codebase with production stability
improvements and final v3.2.1 production installer (698 MB, Inno Setup 6). All v3.2.0
comprehensive production enhancements and prior test infrastructure, command bus, and
KPI system features are carried forward and included in the bundled executable.

---

## Version Alignment

The following canonical version markers are set to `3.2.1`:

- `pyproject.toml` -> `version = "3.2.1"`
- `main.py` -> `app.setApplicationVersion("3.2.1")`
- `docs/README.md` -> current stable `v3.2.1`
- `docs/releases/RELEASE_NOTES.md` -> current stable `v3.2.1`
- `.github/copilot-instructions.md` -> current stable `v3.2.1`
...
### All v3.2.0 Features (carried forward)
...
- All v3.2.0 codebase + version bump to 3.2.1 committed
- Tag `v3.2.1` created for release traceability
