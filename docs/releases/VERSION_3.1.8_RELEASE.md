# AIPacs v3.1.8 Release Notes

**Release date:** 2026-06-02
**Branch:** beta-version
**Previous stable:** v3.1.7

---

## Summary

v3.1.8 is a minor release consolidating the v3.1.7 codebase with production stability
improvements and final v3.1.8 production installer (698 MB, Inno Setup 6). All v3.1.7
...
The following canonical version markers are set to `3.1.8`:

- `pyproject.toml` -> `version = "3.1.8"`
- `main.py` -> `app.setApplicationVersion("3.1.8")`
- `docs/README.md` -> current stable `v3.1.8`
- `docs/releases/RELEASE_NOTES.md` -> current stable `v3.1.8`
- `.github/copilot-instructions.md` -> current stable `v3.1.8`
...
### All v3.1.7 Features (carried forward)
...
- All v3.1.7 codebase + version bump to 3.1.8 committed
- Tag `v3.1.8` created for release traceability
