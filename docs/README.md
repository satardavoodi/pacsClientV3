...
> **Current Stable Version:** v2.3.1 (2026-04-13)
...
- [Fast Mode Download-Viewing Plan](pipelines/FAST_MODE_DOWNLOAD_VIEWING_PLAN.md) â€” Progressive viewing during download
...
- [Version 2.3.1 Release](releases/VERSION_2.3.1_RELEASE.md) â€” Stable release notes for the current published version
- [Version 2.2.7 Release](releases/VERSION_2.2.7_RELEASE.md) â€” Previous stable release snapshot
