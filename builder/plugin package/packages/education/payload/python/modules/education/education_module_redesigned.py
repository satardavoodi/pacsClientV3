...
class MyCoursesPage(QWidget):
    ...
    def setup_ui(self):
        ...
        from modules.education.case_of_day_widget import CaseOfDayPage
...
class EducationModuleRedesigned(QWidget):
    ...
    def on_case_of_day_opened(self, payload: Dict[str, Any]):
        try:
            from modules.education.case_of_day_database import get_case
            from modules.education.case_of_day_viewer_widget import CaseOfDayViewerWidget
